...
Ejemplo: Si se ingresan los números 5, 3 y 7, el programa debe mostrar el número 3
como el menor, el número 7 como el mayor y el número 5 como el que esta en medio.
