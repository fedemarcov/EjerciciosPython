...
#Una vez cargadas, mostrar ambas variables por pantalla, intercambiá sus valores (que lo cargado en
#num1 quede en num2, y viceversa) y volvé a mostrarlas actualizadas.
#Como pensarlo:
