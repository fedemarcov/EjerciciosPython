...
Como pensarlo:
    ...
    3 Calcular el porcentaje que representa la inversión de cada persona en relación al total de la inversión.
        ...
        Almacenar el resultado en una variable correspondiente a cada persona. Opcionalmente, se puede redondear el resultado a un número
        determinado de decimales utilizando la función round().
...
print("La inversion de la persona 1 es: ", porcentaje_inversion_persona1)
print("La inversion de la persona 2 es: ", porcentaje_inversion_persona2)
print("La inversion de la persona 3 es: ", porcentaje_inversion_persona3)